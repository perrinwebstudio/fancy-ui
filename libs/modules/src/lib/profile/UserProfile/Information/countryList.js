export const countryList = [
  ...
  { id: 528, name: 'Alankomaat', alpha2: 'nl', alpha3: 'nld' },
  ...
  { id: 28, name: 'Antigua ja Barbuda', alpha2: 'ag', alpha3: 'atg' },
  { id: 784, name: 'Arabiemiirikunnat', alpha2: 'ae', alpha3: 'are' },
  { id: 32, name: 'Argentiina', alpha2: 'ar', alpha3: 'arg' },
  { id: 51, name: 'Armenia', alpha2: 'am', alpha3: 'arm' },
  { id: 36, name: 'Australia', alpha2: 'au', alpha3: 'aus' },
  { id: 31, name: 'Azerbaidžan', alpha2: 'az', alpha3: 'aze' },
  { id: 44, name: 'Bahama', alpha2: 'bs', alpha3: 'bhs' },
  ...
  { id: 56, name: 'Belgia', alpha2: 'be', alpha3: 'bel' },
  ...
  { id: 70, name: 'Bosnia ja Hertsegovina', alpha2: 'ba', alpha3: 'bih' },
  { id: 72, name: 'Botswana', alpha2: 'bw', alpha3: 'bwa' },
  { id: 76, name: 'Brasilia', alpha2: 'br', alpha3: 'bra' },
  ...
  { id: 214, name: 'Dominikaaninen tasavalta', alpha2: 'do', alpha3: 'dom' },
  { id: 218, name: 'Ecuador', alpha2: 'ec', alpha3: 'ecu' },
  { id: 818, name: 'Egypti', alpha2: 'eg', alpha3: 'egy' },
  { id: 222, name: 'El Salvador', alpha2: 'sv', alpha3: 'slv' },
  { id: 232, name: 'Eritrea', alpha2: 'er', alpha3: 'eri' },
  { id: 724, name: 'Espanja', alpha2: 'es', alpha3: 'esp' },
  { id: 231, name: 'Etiopia', alpha2: 'et', alpha3: 'eth' },
  { id: 710, name: 'Etelä-Afrikka', alpha2: 'za', alpha3: 'zaf' },
  { id: 728, name: 'Etelä-Sudan', alpha2: 'ss', alpha3: 'ssd' },
  { id: 242, name: 'Fidži', alpha2: 'fj', alpha3: 'fji' },
  { id: 608, name: 'Filippiinit', alpha2: 'ph', alpha3: 'phl' },
  ...
  { id: 372, name: 'Irlanti', alpha2: 'ie', alpha3: 'irl' },
  { id: 352, name: 'Islanti', alpha2: 'is', alpha3: 'isl' },
  { id: 376, name: 'Israel', alpha2: 'il', alpha3: 'isr' },
  { id: 380, name: 'Italia', alpha2: 'it', alpha3: 'ita' },
  { id: 626, name: 'Itä-Timor', alpha2: 'tl', alpha3: 'tls' },
  { id: 40, name: 'Itävalta', alpha2: 'at', alpha3: 'aut' },
  { id: 388, name: 'Jamaika', alpha2: 'jm', alpha3: 'jam' },
  { id: 392, name: 'Japani', alpha2: 'jp', alpha3: 'jpn' },
  { id: 887, name: 'Jemen', alpha2: 'ye', alpha3: 'yem' },
  { id: 400, name: 'Jordania', alpha2: 'jo', alpha3: 'jor' },
  { id: 116, name: 'Kambodža', alpha2: 'kh', alpha3: 'khm' },
  ...
  { id: 398, name: 'Kazakstan', alpha2: 'kz', alpha3: 'kaz' },
  { id: 404, name: 'Kenia', alpha2: 'ke', alpha3: 'ken' },
  { id: 140, name: 'Keski-Afrikan tasavalta', alpha2: 'cf', alpha3: 'caf' },
  { id: 156, name: 'Kiina', alpha2: 'cn', alpha3: 'chn' },
  { id: 417, name: 'Kirgisia', alpha2: 'kg', alpha3: 'kgz' },
  { id: 296, name: 'Kiribati', alpha2: 'ki', alpha3: 'kir' },
  { id: 170, name: 'Kolumbia', alpha2: 'co', alpha3: 'col' },
  { id: 174, name: 'Komorit', alpha2: 'km', alpha3: 'com' },
  {
    id: 180,
  ...
  { id: 178, name: 'Kongon tasavalta', alpha2: 'cg', alpha3: 'cog' },
  {
    id: 408,
  ...
  { id: 410, name: 'Korean tasavalta', alpha2: 'kr', alpha3: 'kor' },
  { id: 300, name: 'Kreikka', alpha2: 'gr', alpha3: 'grc' },
  { id: 191, name: 'Kroatia', alpha2: 'hr', alpha3: 'hrv' },
  { id: 192, name: 'Kuuba', alpha2: 'cu', alpha3: 'cub' },
  { id: 414, name: 'Kuwait', alpha2: 'kw', alpha3: 'kwt' },
  { id: 196, name: 'Kypros', alpha2: 'cy', alpha3: 'cyp' },
  ...
  { id: 440, name: 'Liettua', alpha2: 'lt', alpha3: 'ltu' },
  ...
  { id: 462, name: 'Malediivit', alpha2: 'mv', alpha3: 'mdv' },
  { id: 458, name: 'Malesia', alpha2: 'my', alpha3: 'mys' },
  { id: 466, name: 'Mali', alpha2: 'ml', alpha3: 'mli' },
  { id: 470, name: 'Malta', alpha2: 'mt', alpha3: 'mlt' },
  { id: 504, name: 'Marokko', alpha2: 'ma', alpha3: 'mar' },
  { id: 584, name: 'Marshallinsaaret', alpha2: 'mh', alpha3: 'mhl' },
  { id: 478, name: 'Mauritania', alpha2: 'mr', alpha3: 'mrt' },
  { id: 480, name: 'Mauritius', alpha2: 'mu', alpha3: 'mus' },
  { id: 484, name: 'Meksiko', alpha2: 'mx', alpha3: 'mex' },
  { id: 583, name: 'Mikronesian liittovaltio', alpha2: 'fm', alpha3: 'fsm' },
  ...
  { id: 578, name: 'Norja', alpha2: 'no', alpha3: 'nor' },
  { id: 384, name: 'Norsunluurannikko', alpha2: 'ci', alpha3: 'civ' },
  ...
  { id: 598, name: 'Papua-Uusi-Guinea', alpha2: 'pg', alpha3: 'png' },
  { id: 600, name: 'Paraguay', alpha2: 'py', alpha3: 'pry' },
  { id: 604, name: 'Peru', alpha2: 'pe', alpha3: 'per' },
  { id: 807, name: 'Pohjois-Makedonia', alpha2: 'mk', alpha3: 'mkd' },
  { id: 620, name: 'Portugali', alpha2: 'pt', alpha3: 'prt' },
  { id: 616, name: 'Puola', alpha2: 'pl', alpha3: 'pol' },
  { id: 226, name: 'Päiväntasaajan Guinea', alpha2: 'gq', alpha3: 'gnq' },
  { id: 634, name: 'Qatar', alpha2: 'qa', alpha3: 'qat' },
  { id: 250, name: 'Ranska', alpha2: 'fr', alpha3: 'fra' },
  { id: 642, name: 'Romania', alpha2: 'ro', alpha3: 'rou' },
  { id: 646, name: 'Ruanda', alpha2: 'rw', alpha3: 'rwa' },
  { id: 752, name: 'Ruotsi', alpha2: 'se', alpha3: 'swe' },
  { id: 659, name: 'Saint Kitts ja Nevis', alpha2: 'kn', alpha3: 'kna' },
  ...
  { id: 276, name: 'Saksa', alpha2: 'de', alpha3: 'deu' },
  { id: 90, name: 'Salomonsaaret', alpha2: 'sb', alpha3: 'slb' },
  { id: 894, name: 'Sambia', alpha2: 'zm', alpha3: 'zmb' },
  { id: 882, name: 'Samoa', alpha2: 'ws', alpha3: 'wsm' },
  { id: 674, name: 'San Marino', alpha2: 'sm', alpha3: 'smr' },
  { id: 678, name: 'São Tomé ja Príncipe', alpha2: 'st', alpha3: 'stp' },
  ...
  { id: 690, name: 'Seychellit', alpha2: 'sc', alpha3: 'syc' },
  ...
  { id: 246, name: 'Suomi', alpha2: 'fi', alpha3: 'fin' },
  { id: 740, name: 'Suriname', alpha2: 'sr', alpha3: 'sur' },
  { id: 748, name: 'Swazimaa', alpha2: 'sz', alpha3: 'swz' },
  { id: 756, name: 'Sveitsi', alpha2: 'ch', alpha3: 'che' },
  { id: 760, name: 'Syyria', alpha2: 'sy', alpha3: 'syr' },
  { id: 762, name: 'Tadžikistan', alpha2: 'tj', alpha3: 'tjk' },
  { id: 834, name: 'Tansania', alpha2: 'tz', alpha3: 'tza' },
  { id: 208, name: 'Tanska', alpha2: 'dk', alpha3: 'dnk' },
  { id: 764, name: 'Thaimaa', alpha2: 'th', alpha3: 'tha' },
  { id: 768, name: 'Togo', alpha2: 'tg', alpha3: 'tgo' },
  { id: 776, name: 'Tonga', alpha2: 'to', alpha3: 'ton' },
  { id: 780, name: 'Trinidad ja Tobago', alpha2: 'tt', alpha3: 'tto' },
  { id: 148, name: 'Tšad', alpha2: 'td', alpha3: 'tcd' },
  { id: 203, name: 'Tšekki', alpha2: 'cz', alpha3: 'cze' },
  { id: 788, name: 'Tunisia', alpha2: 'tn', alpha3: 'tun' },
  { id: 792, name: 'Turkki', alpha2: 'tr', alpha3: 'tur' },
  ...
  { id: 804, name: 'Ukraina', alpha2: 'ua', alpha3: 'ukr' },
  { id: 348, name: 'Unkari', alpha2: 'hu', alpha3: 'hun' },
  { id: 858, name: 'Uruguay', alpha2: 'uy', alpha3: 'ury' },
  { id: 554, name: 'Uusi-Seelanti', alpha2: 'nz', alpha3: 'nzl' },
  { id: 860, name: 'Uzbekistan', alpha2: 'uz', alpha3: 'uzb' },
  { id: 112, name: 'Valko-Venäjä', alpha2: 'by', alpha3: 'blr' },
  { id: 548, name: 'Vanuatu', alpha2: 'vu', alpha3: 'vut' },
  { id: 862, name: 'Venezuela', alpha2: 've', alpha3: 'ven' },
  { id: 643, name: 'Venäjä', alpha2: 'ru', alpha3: 'rus' },
  { id: 704, name: 'Vietnam', alpha2: 'vn', alpha3: 'vnm' },
  { id: 233, name: 'Viro', alpha2: 'ee', alpha3: 'est' },
  { id: 826, name: 'Yhdistynyt kuningaskunta', alpha2: 'gb', alpha3: 'gbr' },
  { id: 840, name: 'Yhdysvallat', alpha2: 'us', alpha3: 'usa' },
