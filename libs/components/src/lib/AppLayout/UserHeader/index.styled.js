...
export const StyledAppUserHeader = styled(Header)`
  padding-left: 20px;
  padding-right: 20px;
...
export const StyledAppUserHeaderSearch = styled(Search)`
  position: relative;
  max-width: 140px;
  min-height: 36px;
  margin-left: auto;
...
export const StyledAppUserHeaderSectionDesktop = styled.div`
  display: none;
...
export const StyledAppUserHeaderSectionMobile = styled.div`
  display: block;
...
export const StyledUserHeaderSidebar = styled(MainSidebar)`
  &.ant-layout-sider {
...
export const StyledAppLayoutUserHeader = styled(Layout)`
  min-height: 100vh;
  position: relative;
  background-color: transparent;
  overflow-x: hidden;
...
export const StyledAppLayoutUserHeaderMain = styled(Layout)`
  transition: all 0.1s linear;
  width: 100% !important;
  position: relative;
  flex-shrink: 0;
...
export const StyledUserHeaderMainScrollbar = styled(AppScrollbar)`
  position: relative;
  display: flex;
