import { Modal, Form, Input, Image, Row, Col, Typography } from "antd";
import FloatLabel from "@crema/modules/components/floatLabel";
import { StyledDivider, StyledFormBtn } from "./index.styled";
...
const CreateCompanyModal = ({ isShowModal, handleCloseModal }) => {
  ...
  return (
    ...
    >
      <StyledDivider />
      <Form onFinish={onFinish} initialValues={{}} form={form}>
        <Text strong>Company Nmae</Text>
                ...
                rules={[
                  {
                    validator: () => {
                      if (companyImage) {
                        ...
                        return Promise.reject("Please select company logo!");
                      }
                    },
                  },
                ]}
