...
const SettingPassword = ({ resetPassword, isLoading }) => {
  ...
  const onFinish = (values) => {
    ...
    resetPassword?.({
      successMessage: "You've set the password successfully. Use the password to login!",
  ...
  return (
    <StyledUserPages>
      <AppPageMeta title="Set your password" />
